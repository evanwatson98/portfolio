...
if (mysqli_connect_errno())
	...
	$shelfCheck = mysqli_query($con, "SELECT shelfid from shelfUserV2 WHERE houseID = '$houseID' AND shelfid = (SELECT shelfID FROM Shelf WHERE name ='$foodName')");
	...
	if($result1 == false) {
		...
		if($result = mysqli_query($con,"select shelfid from shelfUserV2 order by shelfid desc limit 1")){
