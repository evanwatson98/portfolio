...
if (mysqli_connect_errno())
	...
	$foodCheck = mysqli_query($con, "SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'");
	$foodCheckRow = mysqli_fetch_array($foodCheck);
	$result1 = $foodCheckRow[0];
   
	//checking if food is already in user's shelf
	$shelfCheck = mysqli_query($con, "SELECT shelfid from shelfUserV2 WHERE userid = $intUserid AND shelfid = (SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType')");
	$shelfCheckRow = mysqli_fetch_array($shelfCheck);
	$result2 = $shelfCheckRow[0];

	$unitInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement')";
	
	$literInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity*1000)";

	$cupInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity*128)";

	$ounceInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity*28)";

	$tablespoonInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity*15)";

	$teaspoonInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity*4)";

	$gramInsert = "INSERT INTO shelfUserV2(shelfid, userid, expiration, quantity, measurement, grams) VALUES((SELECT shelfID FROM Shelf WHERE name ='$foodName' AND foodGroup = '$foodGroup' AND type = '$foodType'), $intUserid, STR_TO_DATE('$foodExpiration','%m-%d-%Y'), $intQuantity, '$foodMeasurement', $intQuantity)";
	...
	if($result1){
		...
		if($result2){    //NEEDS TO BE UPDATED TO WORK WITH GRAMS
			$multiply = 0;
			...
			$update = "UPDATE shelfUserV2 SET grams = grams + ($intQuantity * $multiply) WHERE shelfid = $result1";
	...
	//if food item is new /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if($result1 == false) {
		$insert2 = "INSERT INTO Shelf(name, foodGroup, type) VALUES('$foodName', '$foodGroup', '$foodType')";
